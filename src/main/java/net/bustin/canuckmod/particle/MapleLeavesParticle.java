...
public class MapleLeavesParticle extends TextureSheetParticle {
    ...
    protected MapleLeavesParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel,
            ...
            return new MapleLeavesParticle(clientLevel, pX, pY, pZ, this.spriteSet);
        }
    }
}
