package net.bustin.canuckmod.entity.animations;// Save this class in your mod and generate all required imports
...
public class MooseAnimations {
	public static final AnimationDefinition MOOSE_WALKING = AnimationDefinition.Builder.withLength(4.0F).looping()
