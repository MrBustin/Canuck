package net.bustin.canuckmod.entity.animations;
...
public class BeaverAnimations {
    public static final AnimationDefinition BEAVER_WALKING = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition BEAVER_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
